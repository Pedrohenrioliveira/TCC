...
public class AtualizarClubeValidator : AbstractValidator<AtualizarClubeCommand>
{
    public AtualizarClubeValidator(IClubeRepositorio repositorio)
    {
        RuleFor(x => x.Id)
            .NotEmpty().WithMessage("O identificador do clube é obrigatório.");
