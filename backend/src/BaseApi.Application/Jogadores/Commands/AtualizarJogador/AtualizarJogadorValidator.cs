...
public class AtualizarJogadorValidator : AbstractValidator<AtualizarJogadorCommand>
{
    public AtualizarJogadorValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty().WithMessage("O identificador do jogador é obrigatório.");
