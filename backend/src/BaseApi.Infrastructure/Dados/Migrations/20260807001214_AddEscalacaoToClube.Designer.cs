...
namespace BaseApi.Infrastructure.Dados.Migrations
{
    ...
    [Migration("20260807001214_AddEscalacaoToClube")]
    partial class AddEscalacaoToClube
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BaseApi.Domain.Entidades.Campeonato", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AtualizadoEm = new DateTime(2026, 8, 7, 0, 12, 13, 881, DateTimeKind.Utc).AddTicks(9403),
                            CaminhoImagemCampo = "",
                            CaminhoLogo = "assets/campeonato1.jpg",
                            ChavePix = "",
                            CriadoEm = new DateTime(2026, 8, 7, 0, 12, 13, 881, DateTimeKind.Utc).AddTicks(9398),
                        ...
                        new
                        {
                            ...
                            AtualizadoEm = new DateTime(2026, 8, 7, 0, 12, 13, 881, DateTimeKind.Utc).AddTicks(9427),
                            CaminhoImagemCampo = "",
                            CaminhoLogo = "assets/campeonato2.jpg",
                            ChavePix = "",
                            CriadoEm = new DateTime(2026, 8, 7, 0, 12, 13, 881, DateTimeKind.Utc).AddTicks(9427),
                        ...
                        new
                        {
                            ...
                            AtualizadoEm = new DateTime(2026, 8, 7, 0, 12, 13, 881, DateTimeKind.Utc).AddTicks(9430),
                            CaminhoImagemCampo = "",
                            CaminhoLogo = "assets/campeonato3.jpg",
                            ChavePix = "",
                            CriadoEm = new DateTime(2026, 8, 7, 0, 12, 13, 881, DateTimeKind.Utc).AddTicks(9430),
            ...
            modelBuilder.Entity("BaseApi.Domain.Entidades.Clube", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("11111111-1111-1111-1111-111111111111"),
                            AnoFundacao = 1990,
                            AtualizadoEm = new DateTime(2026, 8, 7, 0, 12, 13, 881, DateTimeKind.Utc).AddTicks(9520),
                            BreveHistoria = "Um clube criado para testes.",
                            CaminhoEscudo = "https://robohash.org/clube1?set=set1",
                            CidadeEstado = "São Paulo / SP",
                            CriadoEm = new DateTime(2026, 8, 7, 0, 12, 13, 881, DateTimeKind.Utc).AddTicks(9519),
            ...
            modelBuilder.Entity("BaseApi.Domain.Entidades.Jogador", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Altura = 180,
                            AtualizadoEm = new DateTime(2026, 8, 7, 0, 12, 13, 881, DateTimeKind.Utc).AddTicks(9471),
                            BioHistorico = "Jogador de teste do sistema.",
                            CaminhoFoto = "https://robohash.org/pedro?set=set5",
                            CriadoEm = new DateTime(2026, 8, 7, 0, 12, 13, 881, DateTimeKind.Utc).AddTicks(9471),
            ...
            modelBuilder.Entity("BaseApi.Domain.Entidades.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NomeUsuario = "admin",
                            PerfilId = 1,
                            SenhaHash = "$2a$11$G9Zh7bfSLCehYlsdNq1/1u.BQx/LJCcb8pAmfzlsm8M1JRiWOhCW6"
                        });
                });
