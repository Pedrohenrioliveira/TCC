...
namespace BaseApi.Infrastructure.Dados.Migrations
{
    ...
    [Migration("20260804223302_AddInscricaoCampeonato")]
    partial class AddInscricaoCampeonato
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BaseApi.Domain.Entidades.Campeonato", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AtualizadoEm = new DateTime(2026, 8, 4, 22, 33, 2, 17, DateTimeKind.Utc).AddTicks(3417),
                            CaminhoLogo = "assets/campeonato1.jpg",
                            CriadoEm = new DateTime(2026, 8, 4, 22, 33, 2, 17, DateTimeKind.Utc).AddTicks(3412),
                        ...
                        new
                        {
                            ...
                            AtualizadoEm = new DateTime(2026, 8, 4, 22, 33, 2, 17, DateTimeKind.Utc).AddTicks(3429),
                            CaminhoLogo = "assets/campeonato2.jpg",
                            CriadoEm = new DateTime(2026, 8, 4, 22, 33, 2, 17, DateTimeKind.Utc).AddTicks(3428),
                        ...
                        new
                        {
                            ...
                            AtualizadoEm = new DateTime(2026, 8, 4, 22, 33, 2, 17, DateTimeKind.Utc).AddTicks(3432),
                            CaminhoLogo = "assets/campeonato3.jpg",
                            CriadoEm = new DateTime(2026, 8, 4, 22, 33, 2, 17, DateTimeKind.Utc).AddTicks(3432),
            ...
            modelBuilder.Entity("BaseApi.Domain.Entidades.Clube", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("11111111-1111-1111-1111-111111111111"),
                            AnoFundacao = 1990,
                            AtualizadoEm = new DateTime(2026, 8, 4, 22, 33, 2, 17, DateTimeKind.Utc).AddTicks(3502),
                            BreveHistoria = "Um clube criado para testes.",
                            CaminhoEscudo = "https://robohash.org/clube1?set=set1",
                            CidadeEstado = "São Paulo / SP",
                            CriadoEm = new DateTime(2026, 8, 4, 22, 33, 2, 17, DateTimeKind.Utc).AddTicks(3502),
            ...
            modelBuilder.Entity("BaseApi.Domain.Entidades.Jogador", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Altura = 180,
                            AtualizadoEm = new DateTime(2026, 8, 4, 22, 33, 2, 17, DateTimeKind.Utc).AddTicks(3472),
                            BioHistorico = "Jogador de teste do sistema.",
                            CaminhoFoto = "https://robohash.org/pedro?set=set5",
                            CriadoEm = new DateTime(2026, 8, 4, 22, 33, 2, 17, DateTimeKind.Utc).AddTicks(3472),
            ...
            modelBuilder.Entity("BaseApi.Domain.Entidades.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NomeUsuario = "admin",
                            PerfilId = 1,
                            SenhaHash = "$2a$11$ouUs2PFfrXpBBkjULO64VO.YBl6PbUS9bpAb4KSASv.t6IyZJdUBu"
                        });
                });
