...
namespace BaseApi.Infrastructure.Dados.Migrations
{
    ...
    [Migration("20260731004117_AddCompeticaoEntities")]
    partial class AddCompeticaoEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BaseApi.Domain.Entidades.Campeonato", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AtualizadoEm = new DateTime(2026, 7, 31, 0, 41, 16, 656, DateTimeKind.Utc).AddTicks(2586),
                            CaminhoLogo = "assets/campeonato1.jpg",
                            CriadoEm = new DateTime(2026, 7, 31, 0, 41, 16, 656, DateTimeKind.Utc).AddTicks(2582),
                        ...
                        new
                        {
                            ...
                            AtualizadoEm = new DateTime(2026, 7, 31, 0, 41, 16, 656, DateTimeKind.Utc).AddTicks(2611),
                            CaminhoLogo = "assets/campeonato2.jpg",
                            CriadoEm = new DateTime(2026, 7, 31, 0, 41, 16, 656, DateTimeKind.Utc).AddTicks(2611),
                        ...
                        new
                        {
                            ...
                            AtualizadoEm = new DateTime(2026, 7, 31, 0, 41, 16, 656, DateTimeKind.Utc).AddTicks(2614),
                            CaminhoLogo = "assets/campeonato3.jpg",
                            CriadoEm = new DateTime(2026, 7, 31, 0, 41, 16, 656, DateTimeKind.Utc).AddTicks(2614),
            ...
            modelBuilder.Entity("BaseApi.Domain.Entidades.Clube", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("11111111-1111-1111-1111-111111111111"),
                            AnoFundacao = 1990,
                            AtualizadoEm = new DateTime(2026, 7, 31, 0, 41, 16, 656, DateTimeKind.Utc).AddTicks(2689),
                            BreveHistoria = "Um clube criado para testes.",
                            CaminhoEscudo = "https://robohash.org/clube1?set=set1",
                            CidadeEstado = "São Paulo / SP",
                            CriadoEm = new DateTime(2026, 7, 31, 0, 41, 16, 656, DateTimeKind.Utc).AddTicks(2689),
            ...
            modelBuilder.Entity("BaseApi.Domain.Entidades.Jogador", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Altura = 180,
                            AtualizadoEm = new DateTime(2026, 7, 31, 0, 41, 16, 656, DateTimeKind.Utc).AddTicks(2646),
                            BioHistorico = "Jogador de teste do sistema.",
                            CaminhoFoto = "https://robohash.org/pedro?set=set5",
                            CriadoEm = new DateTime(2026, 7, 31, 0, 41, 16, 656, DateTimeKind.Utc).AddTicks(2646),
            ...
            modelBuilder.Entity("BaseApi.Domain.Entidades.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NomeUsuario = "admin",
                            PerfilId = 1,
                            SenhaHash = "$2a$11$xd5uxTXi5FOawfFZsP2yuuCAV9N6rp7ZXAFhwKHVBxWjgZCDXz45m"
                        });
                });
